...
async function loadMagasins() {
    ...
    tbody.innerHTML = '<tr><td colspan="7" style="text-align:center;color:#999;">Chargement...</td></tr>';
    ...
    try {
        ...
        if (magasins.length === 0) {
            tbody.innerHTML = '<tr><td colspan="7" style="text-align:center;color:#999;">Aucun magasin inscrit</td></tr>';
            return;
        }
        ...
        console.error('❌ Erreur loadMagasins:', error);
        tbody.innerHTML = '<tr><td colspan="7" style="text-align:center;color:red;">Erreur de connexion</td></tr>';
    }
}
...
console.log('✅ Admin chargé avec succès');
